...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-groupedstats-feedstock/blob/master/LICENSE.txt)
...
Once the `conda-forge` channel has been enabled, `r-groupedstats` can be installed with:

```
conda install r-groupedstats
```

It is possible to list all of the versions of `r-groupedstats` available on your platform with:
